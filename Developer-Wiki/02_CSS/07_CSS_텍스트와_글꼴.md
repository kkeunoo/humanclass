...
- [1. 타이포그래피란?](#css-4)
- [2. 원본 실습 구조](#css-5)
- [3. 원본 HTML 구조 오류](#css-6)
- [4. 올바른 상속 실습 구조](#css-7)
- [5. `font-size`](#css-8)
- [6. 글자 크기 단위](#css-9)
- [7. 웹폰트란?](#css-10)
- [8. 내 코드의 웹폰트](#css-11)
- [9. 강사님 코드의 웹폰트](#css-12)
- [10. `@font-face` 주요 속성](#css-13)
- [11. `font-display: swap`](#css-14)
- [12. 대체 글꼴](#css-15)
- [13. 로컬 폰트와 외부 CDN](#css-16)
- [14. 여러 굵기의 웹폰트](#css-17)
- [15. `font-family`](#css-18)
- [16. `font-style`](#css-19)
- [17. `font-style`과 `<em>`](#css-20)
- [18. `font-weight`](#css-21)
- [19. `font-weight` 기본값](#css-22)
- [20. `font-weight` 범위 보완](#css-23)
- [21. 실제 폰트가 제공하는 굵기](#css-24)
- [22. `bold`와 숫자값](#css-25)
- [23. `line-height`](#css-26)
- [24. `line-height` 값 방식](#css-27)
- [25. 단위 없는 `line-height`의 장점](#css-28)
- [26. 한 줄 수직 가운데 정렬](#css-29)
- [27. `line-height` 수직 정렬의 한계](#css-30)
- [28. `letter-spacing`](#css-31)
- [29. `letter-spacing`의 의미](#css-32)
- [30. 자간 사용 주의](#css-33)
- [31. `text-align`](#css-34)
- [32. `text-align: justify`](#css-35)
- [33. 오른쪽 정렬 원본 비교](#css-36)
- [34. 내 코드 주석 보완](#css-37)
- [35. `text-decoration`](#css-38)
- [36. 의미 요소와 장식](#css-39)
- [37. 링크 밑줄 제거](#css-40)
- [38. `:link`와 `:visited`](#css-41)
- [39. 한 줄 말줄임표](#css-42)
- [40. `white-space: nowrap`](#css-43)
- [41. `overflow: hidden`](#css-44)
- [42. `text-overflow: ellipsis`](#css-45)
- [43. `title` 속성 원본](#css-46)
- [44. 여러 줄 말줄임표 확장 학습](#css-47)
- [45. 긴 단어 줄바꿈](#css-48)
- [46. `word-wrap`과 `overflow-wrap`](#css-49)
- [47. `word-break: break-all`](#css-50)
- [48. `overflow-wrap`과 `word-break` 비교](#css-51)
- [49. `overflow-wrap: anywhere`](#css-52)
- [50. 한국어 줄바꿈과 `word-break`](#css-53)
- [51. 실제 `h1`과 가짜 제목](#css-54)
- [52. 의미와 모양의 차이](#css-55)
- [53. 브라우저 기본 `h1`과 가짜 제목 차이](#css-56)
- [54. 반복 `<br>` 문제](#css-57)
- [55. 세미콜론 누락](#css-58)
- [56. 내 코드 분석](#css-59)
- [57. 내 코드 개선점](#css-60)
- [58. 강사님 코드 분석](#css-61)
- [59. 강사님 코드 개선점](#css-62)
- [60. 내 코드와 강사님 코드 비교](#css-63)
- [61. 원본 통합 개선 예제](#css-64)
- [62. 실무 본문 타이포그래피](#css-65)
- [63. 제목 체계](#css-66)
- [64. 링크 스타일](#css-67)
- [65. 버튼 텍스트](#css-68)
- [66. 긴 URL과 코드 문자열](#css-69)
- [67. 개발자 도구로 글꼴 확인](#css-70)
- [68. 웹폰트가 적용되지 않을 때 점검](#css-71)
- [69. 말줄임표가 안 될 때 점검](#css-72)
- [70. 자주 하는 실수](#css-73)
- [종합실습](#css-74)
- [정답과 해설](#css-75)
- [최종 체크리스트](#css-76)
- [핵심 요약](#css-77)
- [렌더링 복습 카드 — 글꼴 선택과 텍스트 줄 배치](#css-78)
...
### 글꼴이란? 글자 모양과 줄 배치에 영향을 주는 자원

font-family는 요청할 글꼴 목록이고 실제 렌더링 글꼴은 사용 가능한 글리프·로드 결과에 따라 결정됩니다. font-family 문자열이 설정됐다고 외부 글꼴 다운로드 성공까지 증명되는 것은 아닙니다.

원본의 실제 차이:

| 확인 항목 | 내 코드 | 강사님 코드 |
| --- | --- | --- |
| 등록 글꼴 이름 | NostalgicPoliceVibe | OngleipParkDahyeon |
| 웹폰트 파일 | Griun_PolSensibility-Rg.woff2 | Ownglyph_ParkDaHyun.woff2 |
| 살아 있는 자간 | 0em | -0.1em |
| fake-h1 굵기 | bold | 700 |

두 원본은 다른 글꼴을 사용하므로 같은 크기를 설정해도 모양과 줄바꿈 위치가 달라질 수 있습니다. 외부 CDN 응답과 글꼴 제공 굵기도 전제입니다.
...
이것은 문제 구조를 줄인 재현 코드입니다. 두 수업 소스도 p 안에 div를 적었습니다. 브라우저는 p를 자동 종료해 div가 의도한 자식이 아닐 수 있습니다. “부모 32px인데 왜 div가 작지?”를 글꼴 상속만으로 풀지 말고 Elements의 실제 부모부터 확인합니다. 개선 실습은 바깥을 div로 바꿉니다.

font-weight의 초기값은 normal이고 숫자 의미로는 400입니다. 2000은 유효 범위를 벗어납니다. 유효 숫자라도 실제 글꼴이 지원하는 굵기·매칭 때문에 모두 별개의 모양을 보장하지 않습니다. blur와 굵기를 혼동하지 않습니다.

**확인:** 외부 요청·실제 렌더링 글꼴을 확인한 뒤 font-size·line-height·부모 구조를 봅니다. 한 줄 높이를 상자 높이와 맞추는 가운데 정렬은 여러 줄·긴 내용에서 깨질 수 있어 Flexbox 대안을 비교합니다.


### 개발자 도구에서 실제 값을 읽기

07_font.html을 브라우저에서 열고 Console에 다음을 입력합니다. 💡 JavaScript를 이용한 CSS 진단 명령이며 CSS 파일에 쓰는 코드가 아닙니다.

```javascript
getComputedStyle(document.querySelector('.fw-2000')).fontWeight
```

**예상 결과:** 400

다른 상속 스타일이 없다는 전제입니다. font-weight:2000은 무효이고 기본 normal을 읽습니다. 요소가 없다는 오류가 나오면 페이지와 선택 대상을 먼저 확인합니다. getComputedStyle은 API에서 계산·해석된 스타일을 읽고 getBoundingClientRect는 변환이 반영된 표시 경계 상자를 읽습니다. margin까지 포함한 전체 점유를 자동 반환하는 값은 아닙니다. CSS에는 Python의 print가 없으므로 화면 결과와 Console 값 확인을 구분합니다.

### 짧은 점검 문제와 해설

**문제:** font-family의 문자열이 맞으면 웹폰트도 성공했는가?

**해설:** 아닙니다. 실제 폰트 요청과 렌더링 폰트를 따로 확인해야 합니다.
...
현재 숫자 font-weight 문법의 유효 범위는 1~1000입니다. 유효 숫자를 적는 것과 폰트가 그 굵기의 실제 글리프를 제공하는 것은 별개입니다. 가변 폰트는 선언된 굵기 축 범위에서 연속적인 변화를 지원할 수 있고, 정적 폰트는 사용 가능한 굵기에 맞춰 선택·매칭됩니다.
...
에서 1000은 문법적으로 유효하지만 실제 폰트의 지원·매칭 결과를 확인해야 합니다. 2000은 유효 범위 밖이므로 해당 선언이 무시됩니다. “둘 다 폰트가 없어서 비슷하게 보인다”로 묶지 말고 선언 유효성과 자원 지원을 구분합니다. 이전 유효 선언이나 상속값이 결과에 영향을 줄 수 있습니다.
