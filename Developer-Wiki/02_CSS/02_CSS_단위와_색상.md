...
- [1. CSS 단위란?](#css-4)
- [2. 값이 `0`일 때](#css-5)
- [3. 절대 단위와 상대 단위](#css-6)
- [4. `px`](#css-7)
- [5. 원본의 픽셀 실습](#css-8)
- [6. `%`](#css-9)
- [7. 중첩된 `%` 계산](#css-10)
- [8. `%`의 기준은 속성마다 다르다](#css-11)
- [9. `em`](#css-12)
- [10. 중첩된 `em`](#css-13)
- [11. `em`의 실무 활용](#css-14)
- [12. `em`의 누적 문제](#css-15)
- [13. `rem`](#css-16)
- [14. 원본 설명 보완](#css-17)
- [15. 중첩된 `rem`](#css-18)
- [16. `em`과 `rem` 비교](#css-19)
- [17. 루트 글자 크기를 `62.5%`로 설정하는 방식](#css-20)
- [18. 사용자 글자 크기 설정 존중](#css-21)
- [19. 뷰포트란?](#css-22)
- [20. `vw`](#css-23)
- [21. `vh`](#css-24)
- [22. 모바일에서 `100vh` 주의](#css-25)
- [23. `vmin`](#css-26)
- [24. `vmax`](#css-27)
- [25. 뷰포트 단위 비교](#css-28)
- [26. `width: 100%`와 `width: 100vw`](#css-29)
- [27. `height: 100%`와 `height: 100vh`](#css-30)
- [28. 확장 단위 `ch`](#css-31)
- [29. 확장 단위 `lh`](#css-32)
- [30. 확장 단위와 사용 기준](#css-33)
- [31. `calc()`](#css-34)
- [32. `min()`, `max()`, `clamp()`](#css-35)
- [33. 색상 표현 방법](#css-36)
- [34. 색상 키워드](#css-37)
- [35. RGB](#css-38)
- [36. RGBA](#css-39)
- [37. 최신 RGB 알파 표기](#css-40)
- [38. HEX 6자리](#css-41)
- [39. HEX 3자리 축약](#css-42)
- [40. 원본의 반복 색상 선언](#css-43)
- [41. HEX 8자리](#css-44)
- [42. HEX 4자리](#css-45)
- [43. RGB와 HEX 비교](#css-46)
- [44. 알파 채널과 `opacity`의 차이](#css-47)
- [45. `transparent`](#css-48)
- [46. `currentColor`](#css-49)
- [47. HSL 확장 학습](#css-50)
- [48. `color` 속성의 상속](#css-51)
- [49. `font-size`의 상속](#css-52)
- [50. `background-color`는 상속되지 않는다](#css-53)
- [51. 상속 관련 키워드](#css-54)
- [52. 내 코드 분석](#css-55)
- [53. 내 코드 개선점](#css-56)
- [54. 강사님 코드 분석](#css-57)
- [55. 강사님 코드에서 확인된 문제](#css-58)
- [56. 내 코드와 강사님 코드 비교](#css-59)
- [57. 원본을 개선한 비교 실습](#css-60)
- [58. 실무 글자 크기 체계](#css-61)
- [59. 유동형 글자 크기](#css-62)
- [60. 실무 색상 토큰](#css-63)
- [61. 투명 색상 토큰](#css-64)
- [62. 대비와 접근성](#css-65)
- [63. 다크 모드 색상 구조](#css-66)
- [64. 반응형 컨테이너 예제](#css-67)
- [65. 전체 화면 Hero 예제](#css-68)
- [66. 카드 컴포넌트 예제](#css-69)
- [67. 개발자 도구로 계산값 확인](#css-70)
- [68. 단위가 기대와 다를 때 점검 순서](#css-71)
- [69. 색상이 기대와 다를 때 점검 순서](#css-72)
- [70. 자주 하는 실수](#css-73)
- [종합실습](#css-74)
- [종합실습 정답과 해설](#css-75)
- [최종 체크리스트](#css-76)
- [핵심 요약](#css-77)
- [렌더링 복습 카드 — 단위의 기준과 최종 계산값](#css-78)
...
### 상대 단위란? 숫자와 계산 기준을 함께 읽는 방법

상대 단위는 기준 크기와 비율로 최종 길이를 정합니다. 같은 1.5라도 em과 rem은 기준이 다릅니다. 수업에서 중첩된 세 상자에 150%, 1.5em, 1.5rem을 각각 적용한 것은 누적 여부를 관찰하는 실습입니다.

두 파일의 rem 실습 공통 발췌:

```css
#rem .box1 { font-size: 1.5rem; }
#rem .box1 .box2 { font-size: 1.5rem; }
#rem .box1 .box2 .box3 { font-size: 1.5rem; }
```

루트와 바깥 기준 글자 크기를 모두 16px로 가정하면:

| 단계 | 150% 또는 font-size: 1.5em | 1.5rem |
| --- | --- | --- |
| box1 | 16×1.5=24px | 16×1.5=24px |
| box2 | 24×1.5=36px | 16×1.5=24px |
| box3 | 36×1.5=54px | 16×1.5=24px |

%나 em이 무조건 모든 속성에서 부모의 같은 크기를 보는 것은 아닙니다. 여기서는 font-size이므로 부모의 계산된 글자 크기를 사용합니다. padding의 em은 해당 요소의 글자 크기와 연결됩니다. rem의 루트는 보통 html이며 body가 아닙니다. 원본 두 파일의 body 기준이라는 설명은 보완해야 합니다.

CSS px는 CSS 좌표의 단위이지 물리 픽셀 하나와 항상 동일하지 않습니다. 기본 글자 크기 16px도 사용자 설정이 달라지면 고정 사실이 아닙니다. rgba 배경은 해당 색만 반투명하게 만들고 opacity는 요소 전체 결과를 반투명하게 만듭니다.

**재현:** body의 font-size만 20px로 바꾸고 rem과 em 그룹의 차이를 봅니다. 이어 html의 font-size를 바꾸면 rem도 변합니다. 새로 계산한 값으로 표를 작성하세요.

💡 뷰포트 단위는 브라우저 화면 기준이고 %는 속성별 기준입니다. 모바일의 주소 표시줄 변화 등은 동적 뷰포트 단위로 확장해 학습합니다. [단위 표준](https://www.w3.org/TR/css-values-4/)을 참고합니다.


### 개발자 도구에서 실제 값을 읽기

02_단위.html을 브라우저에서 열고 Console에 다음을 입력합니다. 💡 JavaScript를 이용한 CSS 진단 명령이며 CSS 파일에 쓰는 코드가 아닙니다.

```javascript
Array.from(document.querySelectorAll('#rem .box1, #rem .box2, #rem .box3'), e => getComputedStyle(e).fontSize)
```

**예상 결과:** ['24px', '24px', '24px']

루트 글자 크기 16px 기준입니다. 사용자 설정이나 다른 스타일이 있으면 먼저 루트 값을 읽습니다. 요소가 없다는 오류가 나오면 페이지와 선택 대상을 먼저 확인합니다. getComputedStyle은 API에서 계산·해석된 스타일을 읽고 getBoundingClientRect는 변환이 반영된 표시 경계 상자를 읽습니다. margin까지 포함한 전체 점유를 자동 반환하는 값은 아닙니다. CSS에는 Python의 print가 없으므로 화면 결과와 Console 값 확인을 구분합니다.

### 짧은 점검 문제와 해설

**문제:** body만 20px로 바꾸면 rem도 반드시 20을 기준으로 하는가?

**해설:** 아닙니다. rem은 루트 기준입니다. font-size의 em과 %는 부모 계산값을 사용합니다.
