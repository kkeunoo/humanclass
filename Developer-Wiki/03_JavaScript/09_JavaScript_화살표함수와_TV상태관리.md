...
- [개념에서 실제 실행까지: 화살표 함수는 짧은 함수 표현식이며 TV는 상태 변경 예제다](#js-09-section-4)
- [57. 내 코드와 강사님 코드 비교](#js-09-section-61)
- [59. 실무형 예제: TV 컨트롤러 객체](#js-09-section-63)
- [60. 대표 오류로 이해하기](#js-09-section-64)
- [61. 자주 하는 실수](#js-09-section-65)
- [62. 핵심 요약](#js-09-section-66)
- [63. 최종 체크리스트](#js-09-section-67)

<details>
<summary>세부 목차 펼치기 — 번호형 본문 전체</summary>

- [개요](#js-09-section-1)
- [핵심 개념](#js-09-section-2)
- [학습 목표](#js-09-section-3)
- [개념에서 실제 실행까지: 화살표 함수는 짧은 함수 표현식이며 TV는 상태 변경 예제다](#js-09-section-4)
- [1. 09번 파일 구성](#js-09-section-5)
- [2. 일반 함수 표현식](#js-09-section-6)
- [3. 함수 표현식 호출](#js-09-section-7)
- [4. 쉼표 연산자](#js-09-section-8)
- [5. 여러 값 반환](#js-09-section-9)
- [6. 구조 분해 할당](#js-09-section-10)
- [7. 함수 안의 여러 `return`](#js-09-section-11)
- [8. 즉시 실행 함수](#js-09-section-12)
- [9. IIFE의 역할](#js-09-section-13)
- [10. 기본 화살표 함수](#js-09-section-14)
- [11. 매개변수가 없는 경우](#js-09-section-15)
- [12. 매개변수가 하나인 경우](#js-09-section-16)
- [13. 매개변수가 두 개 이상인 경우](#js-09-section-17)
- [14. 암시적 반환](#js-09-section-18)
- [15. 중괄호와 `return`](#js-09-section-19)
- [16. 객체 암시적 반환](#js-09-section-20)
- [17. 원본의 미선언 변수 문제](#js-09-section-21)
- [18. 화살표 함수와 `this`](#js-09-section-22)
- [19. 화살표 함수와 `arguments`](#js-09-section-23)
- [20. 생성자로 사용할 수 없음](#js-09-section-24)
- [21. 일반 함수와 화살표 함수 선택](#js-09-section-25)
- [22. TV 상태 변수](#js-09-section-26)
- [23. 범위 상수](#js-09-section-27)
- [24. 전원 켜기](#js-09-section-28)
- [25. 전원 끄기](#js-09-section-29)
- [26. 전원 토글](#js-09-section-30)
- [27. 내 코드의 `powerOne()`](#js-09-section-31)
- [28. 공통 전원 검사](#js-09-section-32)
- [29. Early Return](#js-09-section-33)
- [30. 직접 채널 변경](#js-09-section-34)
- [31. 원본 채널 주석 불일치](#js-09-section-35)
- [32. 채널 증가](#js-09-section-36)
- [33. 채널 감소](#js-09-section-37)
- [34. 채널 순환](#js-09-section-38)
- [35. 나머지 연산을 이용한 채널 순환](#js-09-section-39)
- [36. 볼륨 증가](#js-09-section-40)
- [37. 볼륨 감소](#js-09-section-41)
- [38. 내 코드의 볼륨 경계 문제](#js-09-section-42)
- [39. Clamp](#js-09-section-43)
- [40. 공통 볼륨 변경 함수](#js-09-section-44)
- [41. 화살표 함수로 기능 연결](#js-09-section-45)
- [42. 음소거 켜기](#js-09-section-46)
- [43. 음소거 끄기](#js-09-section-47)
- [44. 원본의 `muteOn()`·`muteOff()`](#js-09-section-48)
- [45. 음소거 토글](#js-09-section-49)
- [46. 음소거와 실제 볼륨](#js-09-section-50)
- [47. TV 상태를 객체로 묶기](#js-09-section-51)
- [48. 객체 기반 전원 검사](#js-09-section-52)
- [49. 객체 기반 전원 토글](#js-09-section-53)
- [50. 객체 기반 채널 변경](#js-09-section-54)
- [51. 객체 기반 볼륨 변경](#js-09-section-55)
- [52. 객체 기반 음소거](#js-09-section-56)
- [53. 상태 출력 함수](#js-09-section-57)
- [54. 테스트 시나리오](#js-09-section-58)
- [55. 내 코드와 강사님 코드의 테스트 차이](#js-09-section-59)
- [56. 상태 관리 함수의 공통 원칙](#js-09-section-60)
- [57. 내 코드와 강사님 코드 비교](#js-09-section-61)
- [58. 기존 코드에서 개선 코드로 바꾼 이유](#js-09-section-62)
- [59. 실무형 예제: TV 컨트롤러 객체](#js-09-section-63)
- [60. 대표 오류로 이해하기](#js-09-section-64)
- [61. 자주 하는 실수](#js-09-section-65)
- [62. 핵심 요약](#js-09-section-66)
- [63. 최종 체크리스트](#js-09-section-67)
- [마무리](#js-09-section-68)
- [V3 실행 추적 카드 — 이벤트 → 상태 변경 → 화면 표현](#js-09-section-69)

</details>

---

<a id="js-09-section-1"></a>
...
<a id="js-09-section-3"></a>

## 학습 목표

- 반환값 문법과 상태·출력의 차이를 이해한다.
- 원본의 해당 부분을 찾아 실행 순서와 결과를 다시 확인한다.

---

<a id="js-09-section-4"></a>

## 개념에서 실제 실행까지: 화살표 함수는 짧은 함수 표현식이며 TV는 상태 변경 예제다

함수 문법을 짧게 바꾸는 것과 동작을 같게 만드는 것은 별개다. return a,b는 쉼표 연산자로 마지막 b만 반환한다. 블록 안에는 서로 다른 분기에서 여러 return을 둘 수 있지만 실제 호출에서는 한 번 반환하면 함수가 끝난다. 객체를 암시적으로 반환하려면 () => ({value:1})처럼 괄호가 필요하다.

두 09_arrow 원본에는 fn1(1,2) 다음 줄이 (function...)으로 시작하고 세미콜론이 없다. 줄바꿈만으로 항상 문장이 끝나지는 않아 앞 호출의 결과를 다시 함수처럼 호출하려다 TypeError가 날 수 있다. 기존 문서의 개별 예제를 따로 실행하면 놓치기 쉬운 원본 전체 실행 문제다. IIFE 앞에 ;를 붙이거나 이전 문장을 명확히 끝낸다.

TV 원본의 실제 상수는 채널0~10, 볼륨0~5다. '0~100' 주석보다 실행 상수가 우선한다. 내 volUp/volDown은 경계 분기에서 음소거 해제가 누락될 수 있지만 강사님 volumeUp/Down은 먼저 status_mute=false를 설정한다. 음소거 출력만 0으로 보여 주는 것과 실제 mute 상태를 바꾸는 것도 구분한다.

### 수업 원본에서 사용한 부분

아래는 전체 실행 파일이 아니라 **개념에 대응하는 문맥 발췌**다. 나머지 HTML·선언·등록 코드는 원본과 기존 번호형 본문에서 이어 확인한다. 

내 코드: `workspace_html/javascript/09_arrow.html`
...
강사님 코드: `workspace_teacher/workspace_html/javascript/09_arrow.html`
...
```javascript
const pair = (a, b) => { return a, b; };
console.log(pair(1, 2));
const make = () => ({value: 1});
console.log(JSON.stringify(make()));
;(() => console.log("IIFE"))();
const tv = {power: true, channel: 10, volume: 5, muted: true};
tv.channel = tv.channel === 10 ? 0 : tv.channel + 1;
tv.muted = false;
tv.volume = Math.min(5, tv.volume + 1);
...
{"value":1}
IIFE
{"power":true,"channel":0,"volume":5,"muted":false}
```

### 결과를 역추적하는 방법

화살표의 this는 주변 렉시컬 this를 사용하며 항상 window인 것은 아니다. volume이 이미 최대여도 볼륨 조작이 음소거를 해제해야 한다는 요구사항을 독립적으로 검사한다.
...
**기본 실습:** TV 채널10에서up,0에서down,볼륨5에서up의 다음 상태를 예측한다.

**응용·디버깅 실습:** fn1 호출 다음 줄이 IIFE의 (로 시작하는 원본을 안전하게 분리한다.
...
1. 채널은0과10으로 순환하고 볼륨은5로 고정된다. 음소거는 볼륨 조작 요구사항에 따라 해제한다.
2. 이전 문장 끝에 ; 또는 IIFE 앞에 ;를 넣는다. fn1 반환 숫자를 함수로 호출하려는 연결을 막는다.
...
**질문:** 전원이 꺼져 있으면 channelUp이 마지막 채널을 바꿔도 될까?

**해설:** 수업 요구사항에서는 바꾸지 않는다. 전원 검사 → 입력·범위 검사 → 상태 변경 → 결과 출력 순서로 처리한다.

**한 번 더 확인:** 예제의 입력을 하나 바꾸고 결과를 먼저 예상한 뒤 실행한다. 정상 입력만 아니라 비어 있는 값, 경계값, 두 번 실행했을 때의 상태를 기존 실습·오류 절에서 반복 확인한다.

---

<a id="js-09-section-5"></a>
