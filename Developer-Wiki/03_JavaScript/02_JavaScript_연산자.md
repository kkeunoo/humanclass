...
- [개념에서 실제 실행까지: 연산자는 결과값을 만들며, 일부 연산자는 원래 상태도 바꾼다](#js-02-section-4)
- [7. 전위·후위 증가 비교](#js-02-section-11)
- [20. 느슨한 동등 비교 `==`](#js-02-section-24)
- [21. 느슨한 부등 비교 `!=`](#js-02-section-25)
- [22. 엄격한 동등 비교 `===`](#js-02-section-26)
- [23. 엄격한 부등 비교 `!==`](#js-02-section-27)
- [24. `==`와 `===` 비교](#js-02-section-28)
- [25. `typeof` 비교](#js-02-section-29)
- [26. 크기 비교 연산자](#js-02-section-30)
- [27. 문자열 크기 비교](#js-02-section-31)
- [46. 내 코드와 강사님 코드 비교](#js-02-section-50)
- [48. 실무형 예제: 쿠폰 할인 계산](#js-02-section-52)
- [49. 대표 오류로 이해하기](#js-02-section-53)
- [50. 자주 하는 실수](#js-02-section-54)
- [51. 핵심 요약](#js-02-section-55)
- [52. 최종 체크리스트](#js-02-section-56)

<details>
<summary>세부 목차 펼치기 — 번호형 본문 전체</summary>

- [개요](#js-02-section-1)
- [핵심 개념](#js-02-section-2)
- [학습 목표](#js-02-section-3)
- [개념에서 실제 실행까지: 연산자는 결과값을 만들며, 일부 연산자는 원래 상태도 바꾼다](#js-02-section-4)
- [1. 산술 연산자](#js-02-section-5)
- [2. 기본 대입 연산자](#js-02-section-6)
- [3. 복합 대입 연산자](#js-02-section-7)
- [4. 증감 연산자](#js-02-section-8)
- [5. 후위 증가 `value++`](#js-02-section-9)
- [6. 전위 증가 `++value`](#js-02-section-10)
- [7. 전위·후위 증가 비교](#js-02-section-11)
- [8. 후위 증가가 포함된 계산](#js-02-section-12)
- [9. 전위·후위 증가 혼합](#js-02-section-13)
- [10. 감소 연산 혼합](#js-02-section-14)
- [11. 복잡한 증감식 개선](#js-02-section-15)
- [12. 증감 연산자와 복합 대입](#js-02-section-16)
- [13. 논리 AND `&&`](#js-02-section-17)
- [14. 논리 OR `||`](#js-02-section-18)
- [15. 논리 NOT `!`](#js-02-section-19)
- [16. 논리 연산자는 Boolean만 반환할까?](#js-02-section-20)
- [17. 단락 평가](#js-02-section-21)
- [18. 기본값과 `||`](#js-02-section-22)
- [19. Null 병합 연산자 `??`](#js-02-section-23)
- [20. 느슨한 동등 비교 `==`](#js-02-section-24)
- [21. 느슨한 부등 비교 `!=`](#js-02-section-25)
- [22. 엄격한 동등 비교 `===`](#js-02-section-26)
- [23. 엄격한 부등 비교 `!==`](#js-02-section-27)
...
- [26. 크기 비교 연산자](#js-02-section-30)
- [27. 문자열 크기 비교](#js-02-section-31)
- [28. 삼항 조건 연산자](#js-02-section-32)
- [29. 홀수 판별](#js-02-section-33)
- [30. 삼항 연산자 사용 기준](#js-02-section-34)
- [31. 문제 1: 구매 가능 수량](#js-02-section-35)
- [32. 구매 가능 수량 개선](#js-02-section-36)
- [33. 문제 2: 할인 가격](#js-02-section-37)
- [34. 할인 계산 과정](#js-02-section-38)
- [35. 할인율 소수 표현](#js-02-section-39)
- [36. 문제 3: 10의 자리 이하 버림](#js-02-section-40)
- [37. 자리수 버림 개선](#js-02-section-41)
- [38. 음수 자리수 처리 주의](#js-02-section-42)
- [39. 문제 4: 소수점 둘째 자리까지 자르기](#js-02-section-43)
- [40. 소수점 자르기 개선](#js-02-section-44)
- [41. 자르기와 반올림 구분](#js-02-section-45)
- [42. `toFixed()` 주의](#js-02-section-46)
- [43. 문제 5: 화폐 분배](#js-02-section-47)
- [44. 화폐 분배 계산 과정](#js-02-section-48)
- [45. 화폐 분배 개선](#js-02-section-49)
- [46. 내 코드와 강사님 코드 비교](#js-02-section-50)
- [47. 기존 코드에서 개선 코드로 바꾼 이유](#js-02-section-51)
- [48. 실무형 예제: 쿠폰 할인 계산](#js-02-section-52)
- [49. 대표 오류로 이해하기](#js-02-section-53)
- [50. 자주 하는 실수](#js-02-section-54)
- [51. 핵심 요약](#js-02-section-55)
- [52. 최종 체크리스트](#js-02-section-56)
- [마무리](#js-02-section-57)
- [V3 실행 추적 카드 — 피연산자 → 강제 변환 → 결과](#js-02-section-58)

</details>

---

<a id="js-02-section-1"></a>
...
<a id="js-02-section-3"></a>

## 학습 목표

- 전위·후위의 사용값과 변경 후 상태를 각각 추적한다.
- 원본의 해당 부분을 찾아 실행 순서와 결과를 다시 확인한다.

---

<a id="js-02-section-4"></a>

## 개념에서 실제 실행까지: 연산자는 결과값을 만들며, 일부 연산자는 원래 상태도 바꾼다

++k와 k++는 모두 피연산자 하나를 사용하는 단항 연산이다. 앞에 있으면 증가된 값을 표현식 결과로 쓰고, 뒤에 있으면 이전 값을 결과로 쓰되 변수는 증가시킨다. '나중에 증가'란 전체 문장이 끝날 때까지 상태 변화가 미뤄진다는 뜻이 아니다.

두 원본의 ++k + k++는 왼쪽 표현식부터 평가한다. k=10에서 ++k는 상태를 11로 만들고 11을 준다. 다음 k++는 11을 준 뒤 k를 12로 만든다. 합은 22다. k-- + ++k - --k도 10을 사용하고 k=9, 10을 사용하고 k=10, 9를 사용하고 k=9가 되므로 10+10-9=11이다.

수업에서는 parseInt(10000 / 4800)와 나머지를 사용해 구매량과 잔돈을 구했다. 이는 양수 예제에서는 맞지만 parseInt는 본래 문자열 해석 함수다. 💡 수치의 정수 부분만 필요하면 Math.trunc, 내림이면 Math.floor로 의도를 표현한다. 금융 계산의 반올림 정책은 별도로 정해야 한다.

### 수업 원본에서 사용한 부분

아래는 전체 실행 파일이 아니라 **개념에 대응하는 문맥 발췌**다. 나머지 HTML·선언·등록 코드는 원본과 기존 번호형 본문에서 이어 확인한다. 

내 코드: `workspace_html/javascript/02_op.html`
...
강사님 코드: `workspace_teacher/workspace_html/javascript/02_op.html`
...
console.log(m, k);
console.log(3 == "3", 3 === "3");
console.log(Math.trunc(10000 / 4800), 10000 % 4800);
```
...
연산 결과와 상태를 같은 칸에 쓰지 말고 '사용한 값 / 변경 뒤 값'으로 나눠 적는다. &&와 ||도 항상 Boolean만 반환하는 것이 아니라 선택된 피연산자 값을 반환한다.
...
**기본 실습:** 17000원을5000원·1000원으로 지급하되5000원을 최대한 사용한다.

**응용·디버깅 실습:** -1.9를 Math.floor와 Math.trunc로 각각 처리한다.
...
1. 5000원3장, 남은2000원은1000원2장이다. Math.trunc(total/5000), total%5000 순서로 구한다.
2. floor는-2, trunc는-1이다. 양수에서 같던 버림 코드도 음수에서는 차이가 난다.
...
**질문:** 왜 0 || 100은 100인가? 기본값을 주면 늘 맞을까?

**해설:** 0이 Falsy라 오른쪽 100을 반환한다. 0이 유효한 금액이라면 의도와 다르며, null·undefined만 대체하는 ??를 고려한다.

**한 번 더 확인:** 예제의 입력을 하나 바꾸고 결과를 먼저 예상한 뒤 실행한다. 정상 입력만 아니라 비어 있는 값, 경계값, 두 번 실행했을 때의 상태를 기존 실습·오류 절에서 반복 확인한다.

---

<a id="js-02-section-5"></a>
