...
- [학습 목표](#py-18-section-4)
- [개념에서 실제 실행까지 — 정규표현식이란? — 패턴 검사와 실제 값 검증](#py-18-section-5)
- [48. 핵심 요약](#py-18-section-53)
- [49. 최종 체크리스트](#py-18-section-54)

<details>
<summary>상세 목차 전체 펼치기</summary>

- [문서 정보](#py-18-section-1)
- [개요](#py-18-section-2)
- [핵심 개념](#py-18-section-3)
- [학습 목표](#py-18-section-4)
- [개념에서 실제 실행까지 — 정규표현식이란? — 패턴 검사와 실제 값 검증](#py-18-section-5)
- [1. `re` 모듈](#py-18-section-6)
- [2. 원시 문자열 `r"..."`](#py-18-section-7)
- [3. 일반 문자 일치](#py-18-section-8)
- [4. `.` 메타문자](#py-18-section-9)
- [5. 숫자 패턴 `\d`](#py-18-section-10)
- [6. 단어 문자 `\w`](#py-18-section-11)
- [7. 공백 문자 `\s`](#py-18-section-12)
- [8. 문자 클래스 `[]`](#py-18-section-13)
- [9. 문자 범위](#py-18-section-14)
- [10. 부정 문자 클래스 `[^...]`](#py-18-section-15)
- [11. 수량자 `*`](#py-18-section-16)
- [12. 수량자 `+`](#py-18-section-17)
- [13. 수량자 `?`](#py-18-section-18)
- [14. 정확한 반복 횟수 `{n}`](#py-18-section-19)
- [15. 반복 범위 `{m,n}`](#py-18-section-20)
- [16. 문자열 시작 `^`](#py-18-section-21)
- [17. 문자열 끝 `$`](#py-18-section-22)
- [18. 선택 패턴 `|`](#py-18-section-23)
- [19. 그룹 `()`](#py-18-section-24)
- [20. 이름 있는 그룹](#py-18-section-25)
- [21. 비캡처 그룹 `(?:...)`](#py-18-section-26)
- [22. `search()`](#py-18-section-27)
- [23. `match()`](#py-18-section-28)
- [24. `fullmatch()`](#py-18-section-29)
- [25. `findall()`](#py-18-section-30)
- [26. `finditer()`](#py-18-section-31)
- [27. 일치 객체의 주요 메서드](#py-18-section-32)
- [28. `sub()` 문자열 치환](#py-18-section-33)
- [29. 그룹을 이용한 치환](#py-18-section-34)
- [30. 함수로 치환하기](#py-18-section-35)
- [31. `split()`](#py-18-section-36)
- [32. 탐욕적 수량자](#py-18-section-37)
- [33. 비탐욕적 수량자](#py-18-section-38)
- [34. 플래그](#py-18-section-39)
- [35. 패턴 컴파일 `re.compile()`](#py-18-section-40)
- [36. 전화번호 형식 검사](#py-18-section-41)
- [37. 이메일 형식 검사](#py-18-section-42)
- [38. 날짜 형식 추출](#py-18-section-43)
- [39. 로그 데이터 추출](#py-18-section-44)
- [40. 실무에서는 어떻게 사용할까?](#py-18-section-45)
- [41. 패턴을 읽기 쉽게 작성하기](#py-18-section-46)
- [42. 정규표현식과 성능](#py-18-section-47)
- [43. 대표 오류로 이해하기](#py-18-section-48)
- [44. 정규표현식 구조 읽기](#py-18-section-49)
- [45. 기존 방식에서 개선된 이해](#py-18-section-50)
- [46. 자주 하는 실수](#py-18-section-51)
- [47. 면접·복습 포인트](#py-18-section-52)
- [48. 핵심 요약](#py-18-section-53)
- [49. 최종 체크리스트](#py-18-section-54)
- [마무리](#py-18-section-55)
- [V3 동작 백과 보강 — 패턴 검사와 Match 객체](#py-18-section-56)

</details>

---

<a id="py-18-section-1"></a>
...
| 분류 | `04_Python` |
| 권장 선수 학습 | `03_Python_문자열과_포매팅.md`, `08_Python_조건문과_패턴매칭.md`, `09_Python_반복문.md`, `11_Python_함수.md` |
...
<a id="py-18-section-4"></a>

## 학습 목표

- 검색·전체 일치·문자 범위·결과 객체를 구분한다.
- 예제의 입력·처리·출력과 대표 실패 조건을 직접 확인한다.

---

<a id="py-18-section-5"></a>

## 개념에서 실제 실행까지 — 정규표현식이란? — 패턴 검사와 실제 값 검증

<a id="index-section-7"></a>

### 무엇이며 왜 배워야 할까?

정규표현식은 문자열의 형식을 패턴으로 표현하여 검색·추출·치환하는 도구다. Python에서는 re 모듈을 사용한다. search는 문자열 안에서 일치를 찾고 match는 시작 위치에서 찾으며 fullmatch는 전체 입력이 패턴을 만족하는지 검사한다. 형식 검증에 match만 쓰면 뒤의 불필요한 문자열을 놓칠 수 있다.

[A-Z]는 ASCII 대문자 범위, [a-z]는 소문자 범위다. 둘 다 필요하면 [A-Za-z]로 적는다. [A-z]는 그 코드 범위 사이의 대괄호·역슬래시·밑줄 등도 포함해 알파벳만이라는 뜻이 아니다. [a-Z]는 시작이 끝보다 뒤인 잘못된 범위라 re.error가 난다.

일치가 있으면 Match 객체가, 없으면 None이 돌아오므로 확인 없이 group을 호출하면 AttributeError다. r'...' 원시 문자열은 Python 문자열 이스케이프를 단순화하지만 정규식 문법 자체를 비활성화하지 않는다.

💡 별도 18번 구현 원본은 없으며 14번의 후속 주제 메모에서 확장했다. 이메일 패턴은 학습용 기본 형식 검사이고 계정의 실재 여부·전체 국제 표준까지 보장하지 않는다. 날짜 모양이 맞아도 실제 달력 날짜 여부는 별도 검증한다.
...
```python
import re
pattern = r'[A-Za-z]+_[0-9]{2}'
for text in ['User_01', 'User_01extra', '_ser_01']:
    match = re.fullmatch(pattern, text)
    print(text, bool(match))
print(bool(re.fullmatch(r'[A-z]+', '_')))
print(bool(re.fullmatch(r'[A-Za-z]+', '_')))
try:
    re.compile(r'[a-Z]')
except re.error:
    print('잘못된 범위')
...
1. 패턴은 raw 문자열로 만든 str이고 검사할 각 text도 str이다.
2. fullmatch가 전체 입력을 검사하여 Match 또는 None을 반환한다.
3. bool이 검사 성공 여부를 화면에 표시할 값으로 바꾼다.
4. 별도 범위 예제로 밑줄 포함 여부와 잘못된 범위의 컴파일 실패를 확인한다.

### 원본에서 어디에 사용했을까?


#### 내 코드: `14_try.py` 161~161행
...
\d는 Python str 패턴에서 기본적으로 ASCII 숫자만 뜻하지 않는다. 명세가 0~9이면 [0-9]나 필요한 플래그를 선택한다. 출력 repr와 원시 문자열을 구분해 패턴을 확인한다.
...
1. User_01extra를 search로 검사하면 왜 성공할 수 있을까?
2. 2026-02-31이 날짜 정규식과 맞으면 실제 날짜로 확정해도 되는가?

<details>
<summary>정답과 이유 보기 — 먼저 출력·상태를 예측한 뒤 펼치기</summary>

1. 그 안의 User_01 부분이 일치하기 때문이다. 전체 형식 검사는 fullmatch로 범위를 명확히 한다.
2. 안 된다. 정규식은 모양을 검사한다. datetime.date 등의 달력 검증이 별도로 필요하다.
...
<a id="py-18-section-39"></a>

## 34. 플래그

정규표현식 동작 방식을 플래그로 변경할 수 있다.

<a id="index-section-67"></a>
...
<a id="py-18-section-52"></a>

## 47. 면접·복습 포인트

<a id="index-section-116"></a>
