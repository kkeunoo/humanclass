...
- [학습 목표](#py-10-section-4)
- [개념에서 실제 실행까지 — 파일 입출력이란? — 경로, 모드, 커서와 직렬화](#py-10-section-5)
- [37. 단어 검색 실습 요구사항](#py-10-section-42)
- [45. 내 코드와 강사님 코드 비교](#py-10-section-50)
- [50. 핵심 요약](#py-10-section-55)
- [51. 최종 체크리스트](#py-10-section-56)

<details>
<summary>상세 목차 전체 펼치기</summary>

- [문서 정보](#py-10-section-1)
- [개요](#py-10-section-2)
- [핵심 개념](#py-10-section-3)
- [학습 목표](#py-10-section-4)
- [개념에서 실제 실행까지 — 파일 입출력이란? — 경로, 모드, 커서와 직렬화](#py-10-section-5)
- [1. 파일 열기](#py-10-section-6)
- [2. 쓰기 모드 `w`](#py-10-section-7)
- [3. `write()`](#py-10-section-8)
- [4. 줄바꿈 저장](#py-10-section-9)
- [5. `flush()`](#py-10-section-10)
- [6. `close()`](#py-10-section-11)
- [7. 문자 인코딩](#py-10-section-12)
- [8. UTF-8로 쓰기](#py-10-section-13)
- [9. 읽기 모드 `r`](#py-10-section-14)
- [10. 인코딩을 맞춰 읽기](#py-10-section-15)
- [11. 기본 인코딩 주의](#py-10-section-16)
- [12. `read()`](#py-10-section-17)
- [13. `read(size)`](#py-10-section-18)
- [14. 청크 단위 읽기](#py-10-section-19)
- [15. 파일 끝과 빈 문자열](#py-10-section-20)
- [16. 버퍼링](#py-10-section-21)
- [17. 바이너리 모드 `b`](#py-10-section-22)
- [18. `with`문](#py-10-section-23)
- [19. 예외가 발생해도 닫히는 이유](#py-10-section-24)
- [20. 리스트를 문자열로 저장](#py-10-section-25)
- [21. 문자열을 `list()`로 변환할 때](#py-10-section-26)
- [22. 구조화된 텍스트 저장](#py-10-section-27)
- [23. 직렬화란?](#py-10-section-28)
- [24. `pickle.dump()`](#py-10-section-29)
- [25. `pickle.load()`](#py-10-section-30)
- [26. 저장 순서와 읽기 순서](#py-10-section-31)
- [27. 객체 하나로 묶어 저장](#py-10-section-32)
- [28. `pickle` 보안 주의](#py-10-section-33)
- [29. 추가 모드 `a`](#py-10-section-34)
- [30. `a` 모드에서는 읽을 수 없다](#py-10-section-35)
- [31. `+` 모드](#py-10-section-36)
- [32. 파일 포인터](#py-10-section-37)
- [33. `seek()`](#py-10-section-38)
- [34. `tell()`](#py-10-section-39)
- [35. 파일을 줄 단위로 순회](#py-10-section-40)
- [36. `readline()`과 `readlines()`](#py-10-section-41)
- [37. 단어 검색 실습 요구사항](#py-10-section-42)
- [38. 내 코드의 최종 방식](#py-10-section-43)
- [39. 강사님 코드 방식](#py-10-section-44)
- [40. 구두점 제거 개선](#py-10-section-45)
- [41. 대소문자 구분 없는 검색](#py-10-section-46)
- [42. `pathlib.Path`](#py-10-section-47)
- [43. 파일 존재 여부 확인](#py-10-section-48)
- [44. 파일 모드 선택 기준](#py-10-section-49)
- [45. 내 코드와 강사님 코드 비교](#py-10-section-50)
- [46. 기존 코드에서 개선 코드로 바꾼 이유](#py-10-section-51)
- [47. 실무형 예제: 사용자 설정 저장](#py-10-section-52)
- [48. 대표 오류로 이해하기](#py-10-section-53)
- [49. 자주 하는 실수](#py-10-section-54)
- [50. 핵심 요약](#py-10-section-55)
- [51. 최종 체크리스트](#py-10-section-56)
- [마무리](#py-10-section-57)
- [V3 동작 백과 보강 — 경로에서 Python 객체까지](#py-10-section-58)

</details>

---

<a id="py-10-section-1"></a>
...
<a id="py-10-section-4"></a>

## 학습 목표

- 읽기 위치·텍스트/바이트·복원·안전 조건을 구분한다.
- 예제의 입력·처리·출력과 대표 실패 조건을 직접 확인한다.

---

<a id="py-10-section-5"></a>

## 개념에서 실제 실행까지 — 파일 입출력이란? — 경로, 모드, 커서와 직렬화

<a id="index-section-7"></a>

### 무엇이며 왜 배워야 할까?

파일은 프로세스 밖에 데이터를 보관하고 open은 그 데이터에 접근하는 파일 객체를 만든다. 상대 경로는 현재 작업 디렉터리를 기준으로 해석되며 .py 파일이 있는 위치와 항상 같지는 않다. r은 읽기, w는 기존 내용을 잘라내는 쓰기, a는 뒤에 추가하는 모드다. 실습 전 원본 데이터에 w를 적용하지 않도록 경로와 목적을 확인한다.

read는 현재 커서부터 데이터를 읽고 커서를 이동한다. 두 번째 read가 빈 문자열인 이유는 파일이 비어서가 아니라 이미 끝까지 읽었기 때문일 수 있다. 텍스트 read(10)은 문자 수를 기준으로 하고 rb의 read(10)은 바이트 수를 기준으로 한다. with는 블록을 떠날 때 파일을 닫는 정리 절차를 돕는다.

직렬화는 객체를 저장·전송 가능한 표현으로 바꾸는 일이다. str([1,2])를 읽으면 문자열일 뿐 자동으로 리스트가 복원되지 않는다. JSON은 공통 데이터 형식을, pickle은 Python 객체 직렬화를 제공한다. pickle.load/loads는 코드 실행 위험이 있으므로 신뢰할 수 없는 파일에는 절대로 사용하지 않는다.

아래 StringIO는 디스크 파일이 아니라 메모리 속 텍스트 스트림이다. 파일 삭제·덮어쓰기 없이 커서 동작을 재현하기 위한 💡 확장 예제이며 실제 파일 권한·경로·인코딩 오류까지 검증하지는 않는다.
...
import json
stream = StringIO('사과\n바나나\n')
print(repr(stream.read(3)))
print(repr(stream.read()))
print(repr(stream.read()))
stream.seek(0)
print(repr(stream.readline()))
text = json.dumps({'count': 2})
restored = json.loads(text)
print(type(text).__name__, restored['count'])
stream.close()
```
...
1. StringIO에 직접 넣은 텍스트를 연결하고 커서를 처음에 둔다.
2. read(3)이 '사과\n' 세 문자를 반환하고 커서를 이동한다.
3. 나머지 read가 끝까지 소비한 뒤 다시 read하면 빈 문자열이다. seek(0)이 커서를 처음으로 돌린다.
4. JSON 변환은 dict→str→dict로 진행하고 복원 dict에서 count 값을 조회한다.

### 원본에서 어디에 사용했을까?


#### 내 코드: `10_file.py` 13~19행
...
강사님 원본의 a.webp 바이너리 읽기는 해당 파일이 없으면 중단되지만 내 코드에서는 그 부분이 주석 처리되어 있다. flush는 Python 버퍼를 내보내는 일이며 물리 저장 완료를 항상 보장한다는 설명은 피한다.
...
1. stream.seek(0)을 빼면 readline은? json.loads 실패가 가능한 입력은?
2. 텍스트 끝까지 read한 뒤 파일 내용이 삭제됐다고 판단할 수 있는가?

<details>
<summary>정답과 이유 보기 — 먼저 출력·상태를 예측한 뒤 펼치기</summary>

1. 이미 EOF여서 ''를 반환한다. 문법이 깨진 JSON 문자열 등은 JSONDecodeError를 일으킨다.
2. 없다. 커서가 EOF일 수 있다. seek(0)로 이동해 다시 읽거나 새로 열어 확인하며 w로 열지는 않는다.
