...
- [학습 목표](#py-09-section-4)
- [개념에서 실제 실행까지 — 반복문이란? — 반복 대상, 누적값, 종료 이유](#py-09-section-5)
- [41. 리스트 컴프리헨션과 반복문 비교](#py-09-section-46)
- [46. 내 코드와 강사님 코드 비교](#py-09-section-51)
- [51. 핵심 요약](#py-09-section-56)
- [52. 최종 체크리스트](#py-09-section-57)

<details>
<summary>상세 목차 전체 펼치기</summary>

- [문서 정보](#py-09-section-1)
- [개요](#py-09-section-2)
- [핵심 개념](#py-09-section-3)
- [학습 목표](#py-09-section-4)
- [개념에서 실제 실행까지 — 반복문이란? — 반복 대상, 누적값, 종료 이유](#py-09-section-5)
- [1. `for` 기본 구조](#py-09-section-6)
- [2. `range()`와 종료값](#py-09-section-7)
- [3. `print()`의 `end`](#py-09-section-8)
- [4. 의미 있는 반복 변수](#py-09-section-9)
- [5. `reversed()`](#py-09-section-10)
- [6. 감소하는 `range()`](#py-09-section-11)
- [7. 중첩 반복문](#py-09-section-12)
- [8. 중첩 반복 횟수](#py-09-section-13)
- [9. 기본 구구단](#py-09-section-14)
- [10. 구구단을 3단씩 묶기](#py-09-section-15)
- [11. 범위 검사가 필요한 이유](#py-09-section-16)
- [12. 중복 코드 줄이기](#py-09-section-17)
- [13. 최대 단수 확장](#py-09-section-18)
- [14. `random` 모듈](#py-09-section-19)
- [15. `random.random()`](#py-09-section-20)
- [16. `random.randint()`](#py-09-section-21)
- [17. `while` 기본 구조](#py-09-section-22)
- [18. `while`에서 값 변경](#py-09-section-23)
- [19. 센티널 값](#py-09-section-24)
- [20. 주사위 3이 나올 때까지 반복](#py-09-section-25)
- [21. 주사위 코드 단순화](#py-09-section-26)
- [22. 초기값 선택](#py-09-section-27)
- [23. `break`](#py-09-section-28)
- [24. 중첩 반복문의 `break`](#py-09-section-29)
- [25. `continue`](#py-09-section-30)
- [26. 반복문 `else`](#py-09-section-31)
- [27. 반복문 `else` 실행 조건](#py-09-section-32)
- [28. 검색과 반복문 `else`](#py-09-section-33)
- [29. `for`와 `while` 선택 기준](#py-09-section-34)
- [30. 문자열 반복](#py-09-section-35)
- [31. 문자열 누적 방식](#py-09-section-36)
- [32. 피라미드 규칙](#py-09-section-37)
- [33. Python 방식 피라미드](#py-09-section-38)
- [34. 기존 피라미드와 개선 피라미드](#py-09-section-39)
- [35. 오른쪽 공백은 필요한가?](#py-09-section-40)
- [36. FizzBuzz](#py-09-section-41)
- [37. FizzBuzz 코드](#py-09-section-42)
- [38. FizzBuzz 조건 순서](#py-09-section-43)
- [39. 0과 FizzBuzz](#py-09-section-44)
- [40. 조건 표현식과 리스트 컴프리헨션](#py-09-section-45)
- [41. 리스트 컴프리헨션과 반복문 비교](#py-09-section-46)
- [42. 무한 반복](#py-09-section-47)
- [43. 안전한 무한 반복](#py-09-section-48)
- [44. `turtle` 모듈](#py-09-section-49)
- [45. `turtle` 실행 환경 주의](#py-09-section-50)
- [46. 내 코드와 강사님 코드 비교](#py-09-section-51)
- [47. 기존 코드에서 개선 코드로 바꾼 이유](#py-09-section-52)
- [48. 실무형 예제: 재고 있는 상품 검색](#py-09-section-53)
- [49. 대표 오류로 이해하기](#py-09-section-54)
- [50. 자주 하는 실수](#py-09-section-55)
- [51. 핵심 요약](#py-09-section-56)
- [52. 최종 체크리스트](#py-09-section-57)
- [마무리](#py-09-section-58)
- [V3 동작 백과 보강 — 반복 가능한 값이 하나씩 들어오는 과정](#py-09-section-59)

</details>

---

<a id="py-09-section-1"></a>
...
<a id="py-09-section-4"></a>

## 학습 목표

- 매 회차의 값 변화와 break·else를 추적한다.
- 예제의 입력·처리·출력과 대표 실패 조건을 직접 확인한다.

---

<a id="py-09-section-5"></a>

## 개념에서 실제 실행까지 — 반복문이란? — 반복 대상, 누적값, 종료 이유

### 무엇이며 왜 배워야 할까?

반복문은 같은 규칙을 여러 값에 적용하거나 조건이 바뀔 때까지 실행하는 구조다. for는 반복 가능한 객체에서 값을 하나씩 받아 이름에 연결하고 몸체를 실행한다. while은 매번 조건을 다시 검사한다. 누적 변수 초기화는 반복 전에 하고 매 회차 갱신해야 전체 결과가 만들어진다.

주사위 예제에서 count는 시행 수이고 dice는 마지막 결과다. 원본은 난수를 뽑은 뒤 count를 증가시키므로 3이 나온 회차도 포함한다. UP/DOWN Quiz에서는 정답 회차에서 count를 증가시키지 않아 다른 문제가 생긴다. 비슷한 변수명보다 실제 증가 위치를 확인해야 한다.

반복문의 else는 ‘if 조건이 거짓이면’이 아니라 break 없이 정상적으로 반복을 마쳤을 때 실행된다. 빈 반복도 정상 종료할 수 있다. 함수 return이나 예외로 반복을 빠져나온 경우를 정상 소진과 혼동하지 않는다.

내 원본 FizzBuzz는 range(100)이므로 0부터 99다. 0도 3과 5로 나눈 나머지가 0이므로 첫 출력이 Fizz!Buzz!다. 강사님 별도 fizzbuzz.py는 range(1,101)이며 숫자도 함께 출력한다. 동일 요구사항의 완료 여부는 범위와 표시 방식까지 비교한다. 두 09번 원본 모두 turtle 호출이 있어 GUI 창을 열 수 있다.
...
```python
target = 3
for index, value in enumerate([1, 3, 5], start=1):
    print('확인', index, value)
    if value == target:
        print('찾음')
        break
else:
...
1. for가 [1,3,5]의 반복 상태에서 값을 받아 enumerate의 회차 번호와 연결한다.
2. 각 값을 출력한 뒤 target과 비교한다.
3. 3을 찾으면 break로 반복을 끝내므로 그 반복의 else는 실행하지 않는다.
4. 다음 빈 목록 반복은 값을 얻지 못하고 정상 종료하여 else를 실행한다.

### 원본에서 어디에 사용했을까?


#### 내 코드: `09_for.py` 32~38행
...
피라미드는 행 번호→왼쪽 공백→별 개수→줄바꿈으로 나누어 관찰한다. 내 초기 코드의 range(0,n+1)은 0행도 포함해 빈 줄을 만들 수 있다. 💡 결정적인 테스트에서는 난수를 고정 입력으로 대체한다.
...
1. target=4로 바꾸면 else는 실행될까? count를 반복 안에서 0으로 만들면?
2. range(100)과 range(1,101)의 첫·끝 값과 FizzBuzz 첫 결과를 비교하라.

<details>
<summary>정답과 이유 보기 — 먼저 출력·상태를 예측한 뒤 펼치기</summary>

1. 모든 값을 확인한 뒤 못찾음을 출력한다. 매번 초기화하면 누적되지 않아 전체 시행 수를 잃는다.
2. 각각 0~99와 1~100이다. 첫 범위의 0은 공배수 조건을 만족해 FizzBuzz, 둘째는 1이다. 표시 방식은 코드에 따른다.
