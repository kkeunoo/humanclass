...
- [학습 목표](#py-08-section-4)
- [개념에서 실제 실행까지 — 조건문과 match란? — 입력에서 실행할 가지 선택](#py-08-section-5)
- [1. 비교식의 결과](#py-08-section-6)
- [35. 내 코드와 강사님 코드 비교](#py-08-section-40)
- [40. 핵심 요약](#py-08-section-45)
- [41. 최종 체크리스트](#py-08-section-46)

<details>
<summary>상세 목차 전체 펼치기</summary>

- [문서 정보](#py-08-section-1)
- [개요](#py-08-section-2)
- [핵심 개념](#py-08-section-3)
- [학습 목표](#py-08-section-4)
- [개념에서 실제 실행까지 — 조건문과 match란? — 입력에서 실행할 가지 선택](#py-08-section-5)
- [1. 비교식의 결과](#py-08-section-6)
- [2. `if` 기본 구조](#py-08-section-7)
- [3. 들여쓰기](#py-08-section-8)
- [4. 들여쓰기 오류](#py-08-section-9)
- [5. 중첩 조건문](#py-08-section-10)
- [6. `pass`](#py-08-section-11)
- [7. 불리언이 아닌 조건식](#py-08-section-12)
- [8. Falsy 값](#py-08-section-13)
- [9. Truthy 값](#py-08-section-14)
- [10. 빈 리스트 검사](#py-08-section-15)
- [11. `if·else`](#py-08-section-16)
- [12. 점수 입력](#py-08-section-17)
- [13. 점수를 정수로 변환](#py-08-section-18)
- [14. 내장 함수 이름을 변수명으로 사용하지 않기](#py-08-section-19)
- [15. 점수 범위 검사](#py-08-section-20)
- [16. 줄 연속 문자 `\`](#py-08-section-21)
- [17. 중첩 합격 판정](#py-08-section-22)
- [18. 점수 개수 검증](#py-08-section-23)
- [19. 개선된 점수 판정 예제](#py-08-section-24)
- [20. `if·elif·else`](#py-08-section-25)
- [21. `elif` 실행 순서](#py-08-section-26)
- [22. 조건 순서의 중요성](#py-08-section-27)
- [23. 딕셔너리를 이용한 메뉴 조회](#py-08-section-28)
- [24. `match·case`](#py-08-section-29)
- [25. 여러 값 패턴 `|`](#py-08-section-30)
- [26. 원본의 계절 설명 바로잡기](#py-08-section-31)
- [27. `case _`](#py-08-section-32)
- [28. `match·case`에는 `break`가 필요하지 않다](#py-08-section-33)
- [29. 문자열 패턴](#py-08-section-34)
- [30. `match·case` 선택 기준](#py-08-section-35)
- [31. 조건 표현식](#py-08-section-36)
- [32. 조건 표현식 활용](#py-08-section-37)
- [33. 중첩 조건 표현식](#py-08-section-38)
- [34. Guard Clause](#py-08-section-39)
- [35. 내 코드와 강사님 코드 비교](#py-08-section-40)
- [36. 기존 코드에서 개선 코드로 바꾼 이유](#py-08-section-41)
- [37. 실무형 예제: 주문 상태 안내](#py-08-section-42)
- [38. 대표 오류로 이해하기](#py-08-section-43)
- [39. 자주 하는 실수](#py-08-section-44)
- [40. 핵심 요약](#py-08-section-45)
- [41. 최종 체크리스트](#py-08-section-46)
- [마무리](#py-08-section-47)
- [V3 동작 백과 보강 — 조건이 실행 경로를 고르는 과정](#py-08-section-48)

</details>

---

<a id="py-08-section-1"></a>
...
<a id="py-08-section-4"></a>

## 학습 목표

- 입력 분리·변환·조건 검사와 분기 결과를 연결한다.
- 예제의 입력·처리·출력과 대표 실패 조건을 직접 확인한다.

---

<a id="py-08-section-5"></a>

## 개념에서 실제 실행까지 — 조건문과 match란? — 입력에서 실행할 가지 선택

### 무엇이며 왜 배워야 할까?

조건문은 현재 값이 조건을 만족하는지 판단하여 실행할 블록을 선택한다. if-elif-else에서는 위에서부터 검사해 처음 참인 가지 하나가 실행된다. 들여쓰기는 설명 장식이 아니라 해당 블록의 범위를 정하는 문법이다.

수업 성적 예제는 한 줄의 키보드 입력을 split으로 나누고 각 항목을 int로 변환한 뒤 합계·평균을 계산한다. 입력이 네 개라는 가정을 검사하지 않으면 IndexError가 날 수 있고, 과목 수가 고정되지 않은데 무조건 4로 나누면 정상 종료해도 계산이 틀린다. split(' ')과 split()의 차이도 연속 공백에서 결과에 영향을 준다.

match는 Python 3.10부터의 구조적 패턴 매칭이다. 숫자 상수에 대해 case 6|7|8은 세 값 중 하나를 뜻한다. 다만 case name 같은 이름 패턴은 값 비교가 아니라 캡처가 될 수 있어 단순 switch 복제품으로 외우면 위험하다.

내 08번의 6·7·8월 가지에는 봄이 출력되지만 강사님은 여름이다. 조건 선택 자체는 같고 출력 문자열이 잘못 연결된 차이이므로 정확한 디버깅 지점은 그 가지의 print다.
...
1. raw 입력을 공백 단위로 분리하여 네 개의 str 목록을 얻는다.
2. 개수를 검사하고 맞는 경우 각 문자열을 int로 변환한다.
3. sum과 len으로 평균을 계산하고 목록·평균을 출력한다.
4. month=7이 case 6|7|8과 일치해 여름 가지를 실행하고 case _는 건너뛴다.
...
내·강사님 성적 예제의 sum 이름은 내장 함수를 가리므로 total처럼 역할 이름을 권장한다. 개수 검사만으로 숫자 형식·점수 범위까지 검증된 것은 아니다.
...
1. raw를 '80 90' 또는 '80 90 사과 100'으로 바꾸면?
2. 성적의 개수가 맞고 모두 숫자라면 999도 자동으로 거절되는가?

<details>
<summary>정답과 이유 보기 — 먼저 출력·상태를 예측한 뒤 펼치기</summary>

1. 첫째는 네 과목 안내를 출력한다. 둘째는 개수는 맞지만 int 변환에서 ValueError가 나므로 숫자 형식 처리도 필요하다.
2. 아니다. 과목 수와 형식 검사 외에 0~100 등 요구사항 범위 검사가 필요하다.
