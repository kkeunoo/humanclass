...
- [학습 목표](#py-12-section-4)
- [개념에서 실제 실행까지 — 클래스란? — 객체 상태와 메서드 연결](#py-12-section-5)
- [16. 인스턴스 속성과 클래스 속성 비교](#py-12-section-21)
- [20. 인스턴스 메서드·정적 메서드·클래스 메서드 비교](#py-12-section-25)
- [21. 실습 1: 멜론 차트 관리 시스템](#py-12-section-26)
- [22. 실습 2: 휴먼잡스 계정 관리 시스템](#py-12-section-27)
- [23. 실습 3: 노티드 지점 생성](#py-12-section-28)
- [34. 핵심 요약](#py-12-section-39)
- [35. 최종 체크리스트](#py-12-section-40)

<details>
<summary>상세 목차 전체 펼치기</summary>

- [문서 정보](#py-12-section-1)
- [개요](#py-12-section-2)
- [핵심 개념](#py-12-section-3)
- [학습 목표](#py-12-section-4)
- [개념에서 실제 실행까지 — 클래스란? — 객체 상태와 메서드 연결](#py-12-section-5)
- [1. 클래스란?](#py-12-section-6)
- [2. 클래스 정의와 객체 생성](#py-12-section-7)
- [3. 클래스 이름 규칙](#py-12-section-8)
- [4. `__init__()`과 객체 생성 순서](#py-12-section-9)
- [5. `self`](#py-12-section-10)
- [6. 인스턴스 속성](#py-12-section-11)
- [7. 동적 속성 추가](#py-12-section-12)
- [8. 인스턴스 메서드](#py-12-section-13)
- [9. 속성과 메서드 이름 충돌](#py-12-section-14)
- [10. 비공개 속성과 이름 변환](#py-12-section-15)
- [11. 외부에서 같은 이름을 대입하면?](#py-12-section-16)
- [12. 비공개 메서드](#py-12-section-17)
- [13. 캡슐화](#py-12-section-18)
- [14. Getter와 Setter](#py-12-section-19)
- [15. 클래스 속성](#py-12-section-20)
- [16. 인스턴스 속성과 클래스 속성 비교](#py-12-section-21)
- [17. 변경 가능한 클래스 속성 주의](#py-12-section-22)
- [18. 정적 메서드 `@staticmethod`](#py-12-section-23)
- [19. 클래스 메서드 `@classmethod`](#py-12-section-24)
- [20. 인스턴스 메서드·정적 메서드·클래스 메서드 비교](#py-12-section-25)
- [21. 실습 1: 멜론 차트 관리 시스템](#py-12-section-26)
- [22. 실습 2: 휴먼잡스 계정 관리 시스템](#py-12-section-27)
- [23. 실습 3: 노티드 지점 생성](#py-12-section-28)
- [24. 객체를 다른 객체에 저장하기](#py-12-section-29)
- [25. 실무에서는 어떻게 클래스를 설계할까?](#py-12-section-30)
- [26. 데이터 저장 중심 클래스와 `dataclass`](#py-12-section-31)
- [27. 객체의 문자열 표현 `__str__()`](#py-12-section-32)
- [28. 메모리와 객체 참조 이해](#py-12-section-33)
- [29. 대표 오류로 이해하기](#py-12-section-34)
- [30. 객체와 데이터가 저장되는 구조](#py-12-section-35)
- [31. 기존 코드에서 개선 코드로 바꾼 이유](#py-12-section-36)
- [32. 자주 하는 실수](#py-12-section-37)
- [33. 면접·복습 포인트](#py-12-section-38)
- [34. 핵심 요약](#py-12-section-39)
- [35. 최종 체크리스트](#py-12-section-40)
- [마무리](#py-12-section-41)
- [V3 동작 백과 보강 — 클래스 정의에서 메서드 호출까지](#py-12-section-42)

</details>

---

<a id="py-12-section-1"></a>
...
| 문서 | `12_Python_클래스.md` |
| 분류 | `04_Python` |
| 권장 선수 학습 | `02_Python_변수와_연산자_입출력.md`, `07_Python_딕셔너리와_집합.md`, `11_Python_함수.md` |
...
<a id="py-12-section-4"></a>

## 학습 목표

- 인스턴스·공유 속성·호출·이름 충돌을 설명한다.
- 예제의 입력·처리·출력과 대표 실패 조건을 직접 확인한다.

---

<a id="py-12-section-5"></a>

## 개념에서 실제 실행까지 — 클래스란? — 객체 상태와 메서드 연결

### 무엇이며 왜 배워야 할까?

클래스는 객체의 상태와 행동을 함께 정의하는 틀이다. class 문장을 실행하면 클래스 객체가 만들어지고 Person()처럼 호출하면 인스턴스 생성과 초기화가 진행된다. __init__은 생성된 인스턴스를 초기화하는 메서드이고 self에는 그 인스턴스가 연결된다. 클래스 정의만 해 두었다고 모든 인스턴스의 초기화가 미리 실행되는 것은 아니다.

self.name은 각 인스턴스에 저장되는 속성이고 클래스에 정의한 속성은 조회 경로를 통해 공유될 수 있다. 공유 목록을 인스턴스마다 독립적이라고 생각하면 한 사람의 추가가 다른 사람에게도 보인다. ‘클래스 속성은 정적 메모리 구역에 있으니 무조건 빠르다’처럼 다른 언어의 메모리 설명을 Python의 보장으로 옮기지 않는다.

내·강사님 Person 예제에는 self.hello라는 문자열 속성과 hello라는 메서드가 겹친다. instance.hello 조회는 인스턴스 문자열을 찾으므로 뒤에 ()를 붙이면 TypeError다. 아래 개선 예제는 인사 문자열을 greeting으로 분리했다.

인스턴스 메서드는 self, 클래스 메서드는 cls를 자동으로 받고 정적 메서드는 어느 것도 자동으로 받지 않는다. __money는 이름 맹글링으로 충돌을 줄이지만 보안 접근 통제는 아니다. 변수에 None을 대입한다고 클래스 자체가 소멸하는 것도 아니다.
...
b = Person('지영')
print(a.hello())
print(a.name, b.name, Person.get_count())
print(Person.is_valid_name('   '))
```
...
1. class 문장이 속성과 메서드가 연결된 클래스 객체를 정의한다.
2. Person 호출마다 새 인스턴스를 초기화하고 각 이름을 저장한다.
3. 각 초기화에서 같은 Person.count를 증가시켜 전체 2가 된다.
4. a.hello는 a를 self로 연결한다. get_count는 클래스를 cls로, is_valid_name은 명시 인수만 받는다.

### 원본에서 어디에 사용했을까?


#### 내 코드: `12_class.py` 6~12행
...
수업의 음악·회원 클래스에서는 목록이 클래스 공유 상태인지 개별 객체 상태인지 구분한다. 비밀번호를 반환하는 getter를 좋은 실무 관행으로 소개하지 않는다. 아래 기존 본문에서는 학습용 예제와 운영 인증 설계의 차이를 함께 읽는다.
...
### 실제 오류 재현 — 문자열 속성이 메서드를 가리는 경우

원본의 이름 충돌을 최소 코드로 재현한다. hello 조회 결과가 무엇인지 먼저 찍어야 단순히 괄호를 지우는 처방에서 멈추지 않는다. 올바른 개선은 속성과 행동에 서로 다른 이름을 주는 것이다.
...
class Person:
    ...
    def hello(self):
        print('메서드')
person = Person()
print(type(person.hello).__name__)
try:
    person.hello()
except TypeError:
    print('문자열은 호출할 수 없음')
...
1. Person.count 대신 self.count += 1로 쓰면 같은 전체 인원 계산일까?
2. __money가 이름 맹글링되면 사용자가 절대로 접근할 수 없는 비밀 저장소인가?

<details>
<summary>정답과 이유 보기 — 먼저 출력·상태를 예측한 뒤 펼치기</summary>

1. 인스턴스에 count 속성이 생길 수 있어 클래스 count를 같은 방식으로 갱신하지 않는다. 전체 공유 카운터라면 어떤 클래스에 쓸지 명시한다.
2. 아니다. 실수로 생기는 이름 충돌을 줄이는 기능이다. 접근 경로를 알고 조회할 수 있으므로 보안 비밀 보호와 구분한다.
