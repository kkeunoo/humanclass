...
- [학습 목표](#py-07-section-4)
- [개념에서 실제 실행까지 — 딕셔너리와 집합이란? — 키 조회와 중복 제거](#py-07-section-5)
- [42. 딕셔너리와 집합 비교](#py-07-section-47)
- [43. 내 코드와 강사님 코드 비교](#py-07-section-48)
- [48. 핵심 요약](#py-07-section-53)
- [49. 최종 체크리스트](#py-07-section-54)

<details>
<summary>상세 목차 전체 펼치기</summary>

- [문서 정보](#py-07-section-1)
- [개요](#py-07-section-2)
- [핵심 개념](#py-07-section-3)
- [학습 목표](#py-07-section-4)
- [개념에서 실제 실행까지 — 딕셔너리와 집합이란? — 키 조회와 중복 제거](#py-07-section-5)
- [1. 빈 딕셔너리 생성](#py-07-section-6)
- [2. 키와 값](#py-07-section-7)
- [3. 딕셔너리 키 규칙](#py-07-section-8)
- [4. `dict()`로 생성](#py-07-section-9)
- [5. 대괄호로 값 조회](#py-07-section-10)
- [6. 없는 키 조회와 `KeyError`](#py-07-section-11)
- [7. `get()`으로 안전하게 조회](#py-07-section-12)
- [8. `get()` 기본값](#py-07-section-13)
- [9. 대괄호와 `get()` 선택 기준](#py-07-section-14)
- [10. 중첩 딕셔너리](#py-07-section-15)
- [11. 중첩 값 조회](#py-07-section-16)
- [12. 중첩 `get()`](#py-07-section-17)
- [13. 중첩 `get()`의 오류](#py-07-section-18)
- [14. 빈 딕셔너리를 기본값으로 사용](#py-07-section-19)
- [15. 값 수정](#py-07-section-20)
- [16. 새 키 추가](#py-07-section-21)
- [17. 중첩 값 추가](#py-07-section-22)
- [18. `in`과 `not in`](#py-07-section-23)
- [19. `len()`과 키 개수](#py-07-section-24)
- [20. `keys()`](#py-07-section-25)
- [21. `values()`](#py-07-section-26)
- [22. `items()`](#py-07-section-27)
- [23. 딕셔너리 View 객체](#py-07-section-28)
- [24. `update()`](#py-07-section-29)
- [25. `pop()`](#py-07-section-30)
- [26. `pop()` 기본값](#py-07-section-31)
- [27. `popitem()`](#py-07-section-32)
- [28. `del`](#py-07-section-33)
- [29. `clear()`](#py-07-section-34)
- [30. `dict.fromkeys()`](#py-07-section-35)
- [31. `fromkeys()`의 가변 기본값 주의](#py-07-section-36)
- [32. 딕셔너리 직접 순회](#py-07-section-37)
- [33. `items()`로 키와 값 순회](#py-07-section-38)
- [34. `enumerate()`와 `items()`](#py-07-section-39)
- [35. 딕셔너리 컴프리헨션](#py-07-section-40)
- [36. 딕셔너리 복사](#py-07-section-41)
- [37. 집합 생성](#py-07-section-42)
- [38. 빈 집합](#py-07-section-43)
- [39. 집합의 주요 특징](#py-07-section-44)
- [40. 집합의 추가와 삭제](#py-07-section-45)
- [41. 집합 연산](#py-07-section-46)
- [42. 딕셔너리와 집합 비교](#py-07-section-47)
- [43. 내 코드와 강사님 코드 비교](#py-07-section-48)
- [44. 기존 코드에서 개선 코드로 바꾼 이유](#py-07-section-49)
- [45. 실무형 예제: 장바구니 금액 계산](#py-07-section-50)
- [46. 대표 오류로 이해하기](#py-07-section-51)
- [47. 자주 하는 실수](#py-07-section-52)
- [48. 핵심 요약](#py-07-section-53)
- [49. 최종 체크리스트](#py-07-section-54)
- [마무리](#py-07-section-55)
- [V3 동작 백과 보강 — 키 조회와 중복 제거](#py-07-section-56)

</details>

---

<a id="py-07-section-1"></a>
...
<a id="py-07-section-4"></a>

## 학습 목표

- 키·값·뷰·집합의 동작과 누락 조건을 구분한다.
- 예제의 입력·처리·출력과 대표 실패 조건을 직접 확인한다.

---

<a id="py-07-section-5"></a>

## 개념에서 실제 실행까지 — 딕셔너리와 집합이란? — 키 조회와 중복 제거

### 무엇이며 왜 배워야 할까?

dict는 키로 값을 찾는 매핑이다. 리스트의 위치 조회와 달리 사용자 ID나 상품명 같은 의미 있는 키로 데이터를 찾는다. for key in data와 key in data는 기본적으로 키를 대상으로 한다. data[key]는 키가 없으면 KeyError이고 get은 없을 때 기본값을 반환한다. 키가 존재하며 값이 None인 경우는 ‘키 없음’과 별개다.

keys·values·items는 현재 dict의 내용을 반영하는 뷰다. 처음 얻은 keys를 나중에 출력해도 추가된 키가 보인다. 순회 중 구조를 바꾸는 것은 별도 문제이므로 목록 스냅샷 등 안전한 전략이 필요하다. dict는 삽입 순서를 보존하고 중복 키에 새 값을 넣으면 그 키의 값이 교체된다.

set은 해시 가능한 원소의 중복을 없애고 합집합·교집합 등을 구한다. 출력 순서는 고정된 학습 정답으로 삼지 않는다. 정렬된 결과가 필요하면 sorted를 적용하여 관찰을 안정화한다. {}는 빈 dict이고 빈 set은 set()이다.

원본의 nai 값은 내 코드에서는 '30' 문자열, 강사님 코드에서는 20 정수다. 자료형을 무시하면 후속 계산 결과를 잘못 예상한다. fromkeys(keys,[])의 같은 가변 기본값 공유는 아래 본문의 별도 예제로 복습한다.
...
user['age'] = 30
print(list(keys))
print('age' in user, 30 in user)
print(user.get('job', '미등록'))
user['job'] = None
print(user.get('job', '미등록'))
print(sorted(set(['a', 'b', 'a'])))
```
...
1. user dict와 그 키를 관찰하는 keys 뷰를 만든다.
2. age 키를 추가하여 dict를 변경한다. keys도 변경 후 키를 보여 준다.
3. get은 키가 없을 때만 기본값을 적용하므로 job=None을 넣은 뒤에는 None을 반환한다.
4. set은 중복을 제거하고 sorted가 새 목록으로 정렬하여 출력 순서를 안정화한다.

### 원본에서 어디에 사용했을까?


#### 내 코드: `07_dict.py` 28~34행
...
data.get('profile',{}).get('name')는 profile이 없을 때만 기본 dict가 사용된다. profile=None이면 None.get이 실패하므로 중첩 데이터의 계약을 확인해야 한다.
...
### fromkeys의 가변 기본값 — 키마다 독립 목록 만들기

dict.fromkeys는 전달된 같은 값을 각 키에 연결한다. [] 한 개를 전달하면 그 목록을 공유한다. dict 컴프리헨션의 []는 반복마다 새로 만들어 독립 목록이 된다.
...
1. 'age' in user.values()와 30 in user.values()의 결과는?
2. data={'x':0}에서 data.get('x',9), data.get('y',9)를 비교하라.

<details>
<summary>정답과 이유 보기 — 먼저 출력·상태를 예측한 뒤 펼치기</summary>

1. False와 True다. values 뷰는 키가 아니라 값들을 대상으로 검사한다.
2. 0과 9다. 기본값은 키가 없을 때만 사용하며 falsy 값을 자동으로 바꾸지 않는다.
