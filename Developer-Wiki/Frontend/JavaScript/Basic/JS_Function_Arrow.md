...
> [!NOTE]
> **💡 WHY — 왜 중요한가?**  
> 함수는 하나의 작업을 이름으로 묶고 입력과 결과를 분리한다. 반복되는 코드뿐 아니라 코드의 역할을 설명하고 테스트하기 쉽게 만든다.

> [!TIP]
> **⭐ 실무 TIP**  
> 함수 이름은 동작을 드러내는 동사로 작성하고, 한 함수가 너무 많은 일을 하지 않게 나눈다.

> [!IMPORTANT]
> **📌 반드시 기억하기**  
> 매개변수는 함수가 받을 값이고 return은 함수 밖으로 돌려주는 결과다.

> [!WARNING]
> **⚠️ 주제별 자주 하는 실수**  
> 화살표 함수의 축약 문법만 외우다가 return 또는 중괄호의 의미를 놓치기 쉽다.
