...
> [!IMPORTANT]
> **핵심 목표**  
> 이 문서는 수업 범위 안에서 `글꼴과 텍스트`의 개념, 사용 이유, 기본 문법, 예제, 실수 사례와 복습 질문을 한 번에 학습하도록 구성한다.

| 항목 | 내용 |
|---|---|
| 난이도 | ★★☆☆☆ |
| 예상 학습 시간 | 20~35분 |
| 이전 학습 | `CSS_Float_Shadow` |
| 다음 학습 | `CSS_Media_Query` |
...
글꼴과 텍스트은(는) 이후 예제와 문제를 이해하기 위한 기본 도구다. 문법만 외우기보다 어떤 상황에서 필요하고, 코드가 어떤 순서로 동작하는지 이해해야 다른 문제에도 적용할 수 있다.
...
> [!NOTE]
> **💡 WHY — 왜 중요한가?**  
> 글자는 정보 전달의 핵심이며 크기, 굵기, 줄 간격에 따라 가독성이 크게 달라진다. 폰트 속성을 이해하면 문서의 위계와 읽기 흐름을 만들 수 있다.

> [!TIP]
> **⭐ 실무 TIP**  
> 본문은 글자 크기뿐 아니라 `line-height`와 한 줄 길이도 함께 조절한다.

> [!IMPORTANT]
> **📌 반드시 기억하기**  
> 여러 폰트를 지정할 때는 앞의 폰트를 사용할 수 없을 경우를 대비한 대체 폰트를 둔다.

> [!WARNING]
> **⚠️ 주제별 자주 하는 실수**  
> 너무 많은 font-weight와 크기를 사용하면 제목과 본문의 위계가 흐려진다.
